...
class Analysis(Target):
    ...
    def assemble(self):
        ...
        # Do not reuse dependency graph when option --exclude-module or
        # --additional-hooks-dir was used.
        ...
        # The graph should be complete, so run post-graph hooks.
        self.graph.post_graph_hooks()
